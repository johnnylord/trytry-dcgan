    ...
    def train_one_epoch(self, epoch):
        for batch_idx, (data, target) in enumerate(self.dataloader):
            ...
            if batch_idx % 100 == 0:
                ...
                self.writer_fake.add_scalar('Discriminator Loss', lossD.item(), batch_idx+epoch*len(self.dataloader))
                self.writer_fake.add_scalar('Generator Loss', lossG.item(), batch_idx+epoch*len(self.dataloader))
